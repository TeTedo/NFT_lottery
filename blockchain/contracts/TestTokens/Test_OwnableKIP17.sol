// Bellygom World Official(BELLYGOM)
// 0xce70eef5adac126c37c8bc0c1228d48b70066d03

// Sources flattened with hardhat v2.9.1 https://hardhat.org

// File @klaytn/contracts/utils/Base64.sol@v1.0.2
...
// File @klaytn/contracts/utils/Strings.sol@v1.0.2
...
// File @klaytn/contracts/utils/Context.sol@v1.0.2
...
// File @klaytn/contracts/KIP/utils/introspection/IKIP13.sol@v1.0.2
...
// File @klaytn/contracts/KIP/interfaces/IKIP13.sol@v1.0.2

// Klaytn Contract Library v1.0.0 (KIP/interfaces/IKIP13.sol)

pragma solidity ^0.8.0;

// File @klaytn/contracts/KIP/utils/introspection/KIP13.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/IKIP17.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/IKIP17Metadata.sol@v1.0.2
...
// File @klaytn/contracts/utils/Address.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/IKIP17Receiver.sol@v1.0.2
...
// File @klaytn/contracts/token/ERC721/IERC721Receiver.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/KIP17.sol@v1.0.2
...
contract KIP17 is Context, KIP13, IKIP17, IKIP17Metadata {
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(KIP13, IKIP13) returns (bool) {
        return
...
// File @klaytn/contracts/security/Pausable.sol@v1.0.2
...
// File @klaytn/contracts/access/IAccessControl.sol@v1.0.2
...
// File @klaytn/contracts/access/IAccessControlEnumerable.sol@v1.0.2
...
// File @klaytn/contracts/utils/introspection/IERC165.sol@v1.0.2
...
// File @klaytn/contracts/utils/introspection/ERC165.sol@v1.0.2
...
// File @klaytn/contracts/access/AccessControl.sol@v1.0.2
...
// File @klaytn/contracts/utils/structs/EnumerableSet.sol@v1.0.2
...
// File @klaytn/contracts/access/AccessControlEnumerable.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/IKIP17Pausable.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/KIP17Pausable.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/IKIP17Burnable.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/KIP17Burnable.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/KIP17URIStorage.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/IKIP17MetadataMintable.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/KIP17MetadataMintable.sol@v1.0.2
 ...
 * See https://kips.klaytn.com/KIPs/kip-17#minting-with-uri-extension
 */
abstract contract KIP17MetadataMintable is
    KIP17URIStorage,
    AccessControlEnumerable,
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/IKIP17Mintable.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/KIP17Mintable.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/IKIP17Enumerable.sol@v1.0.2
...
// File @klaytn/contracts/KIP/token/KIP17/extensions/KIP17Enumerable.sol@v1.0.2
...
abstract contract KIP17Enumerable is KIP17, IKIP17Enumerable {
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(IKIP13, KIP17) returns (bool) {
        return
...
// File @klaytn/contracts/access/Ownable.sol@v1.0.2
...
// File contracts/OwnableKIP17.sol

//SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.0;

contract OwnableKIP17 is
    KIP17,
    KIP17Enumerable,
    ...
    Ownable
{
    ...
    function _burn(
        uint256 tokenId
    ) internal virtual override(KIP17, KIP17URIStorage) {
        super._burn(tokenId);
    }
    ...
    function contractURI() public pure returns (string memory) {
        string memory name = "Bellygom World Official";
        //로열티 퍼센트
        string memory seller_fee_basis_points = "750";
        //로열티 지갑
        string
            memory fee_recipient = "0x924Bac06585c1AaCE47955c9Eb0A3F31574daA2c";
